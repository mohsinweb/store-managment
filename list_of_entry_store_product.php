            ...
            <div class="container-fluid">
                <div class="row"><!-- Start of row -->                            
                    ...
                    <?php      
                                            ...
                                            ?>
                                                 <h1 class="text-center text-success">List Of Store Product</h1>
                                            ...
                                            <tr>
                                                    ...
                                                    <td> <?php echo $data['store_product_quantity'] ?></td>
                                                    <td> <?php echo $data['store_product_entrydate'] ?></td>
                                                    <td>
                                                        <a href="edit_store_product.php?id= <?php echo  $data['store_product_id'] ?>">Edit</a><br>
